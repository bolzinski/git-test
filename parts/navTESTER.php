...
<nav class="grid-nav" id="main-nav">
  <div class="main-nav">
    <a href="index.php?cat=6" class="home grid-1-7">
      <span data-icon="k" aria-hidden="true"></span>
      News
    </a>
    <a href="index.php?cat=7" class="sports grid-1-7">
      <span data-icon="9" aria-hidden="true"></span>Sports
    </a>
    <a href="index.php?cat=3" class="business grid-1-7">
      <span data-icon="Q" aria-hidden="true"></span>Business
    </a>
    <a href="index.php?cat=2" class="tech grid-1-7">
      <span data-icon="p" aria-hidden="true"></span>Tech
    </a>
    <a href="index.php?cat=8" class="arts grid-1-7">
      <span data-icon="q" aria-hidden="true"></span>Arts
    </a>
    <a href="index.php?cat=4" class="opinions grid-1-7">
      <span data-icon="ó" aria-hidden="true"></span>Opinions
    </a>
    <a href="index.php?cat=5" class="schools grid-1-7">
